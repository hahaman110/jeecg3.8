package com.jeecg.zjkyreserve.entity;
 ...
 */
@Entity
@Table(name = "zjky_reserve", schema = "")
@SuppressWarnings("serial")
public class ZjkyReserveEntity implements java.io.Serializable {
	/**主键*/
	...
	/**考生类型*/
	@Excel(name="考生类型",width=15,dicCode="userType")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  考生类型
	 */
	@Column(name ="USER_TYPE",nullable=true,length=32)
