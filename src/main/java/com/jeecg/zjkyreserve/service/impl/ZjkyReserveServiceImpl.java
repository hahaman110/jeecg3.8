package com.jeecg.zjkyreserve.service.impl;
...
@Service("zjkyReserveService")
@Transactional
public class ZjkyReserveServiceImpl extends CommonServiceImpl implements ZjkyReserveServiceI {
