package com.jeecg.zjkyschool.service.impl;
...
@Service("zjkySchoolService")
@Transactional
public class ZjkySchoolServiceImpl extends CommonServiceImpl implements ZjkySchoolServiceI {
