package com.jeecg.zjkyschoolmajor.service.impl;
...
@Service("zjkySchoolMajorService")
@Transactional
public class ZjkySchoolMajorServiceImpl extends CommonServiceImpl implements ZjkySchoolMajorServiceI {
