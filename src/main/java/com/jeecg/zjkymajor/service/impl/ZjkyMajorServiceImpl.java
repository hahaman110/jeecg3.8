package com.jeecg.zjkymajor.service.impl;
...
@Service("zjkyMajorService")
@Transactional
public class ZjkyMajorServiceImpl extends CommonServiceImpl implements ZjkyMajorServiceI {
