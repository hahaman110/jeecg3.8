...
public class TreeSelectTag extends TagSupport {
	...
	private boolean cancelPostion = true;
	...
	private void tree(StringBuffer resultSb) {
		...
		String position = cancelPostion?"position: absolute;":""; 
		resultSb.append("  style=\"display: none; position: "+position+"; border: 1px #CCC solid; background-color: #F0F6E4;z-index:9999;\"> ");
	...
	private void getZTreeSeting(StringBuffer resultSb) {
		...
		String chkStyle = multiCheck?"checkbox":"radio";
		String chkboxTypeY = selectCascadeParent?"p":"";
		resultSb.append(",chkStyle:'"+chkStyle+"',chkboxType: { 'Y': '"+chkboxTypeY+"', 'N': '' }");
	...
	public boolean isCancelPostion() {
		return cancelPostion;
	}

	public void setCancelPostion(boolean cancelPostion) {
		this.cancelPostion = cancelPostion;
	}

	public boolean isSelectCascadeParent() {
