...
public class BaseTag extends JeecgTag {
	...
	public StringBuffer end(){
		...
		if (oConvertUtils.isIn("easyui", types)) {
			...
			sb.append("<script type=\"text/javascript\" src=\"plug-in/mutitables/datagrid-filter.js\"></script>");
		}
		...
		if (oConvertUtils.isIn("bootstrap-table", types)) {
			...
			sb.append("<script type=\"text/javascript\" src=\"plug-in/themes/bootstrap-ext/js/bootstrap-lhgdialog-curdtools.js\"></script>");

			sb.append("<link rel=\"stylesheet\" href=\"plug-in/ace/css/common.css\" type=\"text/css\"></link>");
		...
		if (oConvertUtils.isIn("aceform", types)) {
			sb.append("<link rel=\"stylesheet\" href=\"online/template/ledefault/css/vendor.css\" type=\"text/css\"></link>");
			sb.append("<link rel=\"stylesheet\" href=\"online/template/ledefault/css/bootstrap-theme.css\" type=\"text/css\"></link>");
			sb.append("<link rel=\"stylesheet\" href=\"online/template/ledefault/css/bootstrap.css\" type=\"text/css\"></link>");
			sb.append("<link rel=\"stylesheet\" href=\"online/template/ledefault/css/app.css\" type=\"text/css\"></link>");
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/Validform/css/metrole/style.css\" type=\"text/css\"></link>");
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/Validform/css/metrole/tablefrom.css\" type=\"text/css\"></link>");
		...
		if (oConvertUtils.isIn("webuploader", types)) {
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/webuploader/custom.css\" type=\"text/css\"></link>");
		...
		if (oConvertUtils.isIn("bootstrap-form", types)) {
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/themes/bootstrap-ext/css/validform-ext.css\" type=\"text/css\"></link>");
			//icheck组件引用

			sb.append("<link rel=\"stylesheet\" href=\"plug-in/hplus/css/plugins/iCheck/custom.css\" type=\"text/css\"></link>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/iCheck/icheck.min.js\"></script>");

			//通用组件引用 
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/bootstrap3.3.5/css/default.css\" type=\"text/css\"></link>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/themes/bootstrap-ext/js/common.js\"></script>");
			//自定义form样式-一定要放在最后引入
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/bootstrap3.3.5/css/bootstrap-form.css\" type=\"text/css\"></link>");
		}
		if (oConvertUtils.isIn("ueditor", types)) {
			sb.append("<script type=\"text/javascript\" charset=\"utf-8\" src=\"plug-in/ueditor/ueditor.config.js\"></script>");
			sb.append("<script type=\"text/javascript\" charset=\"utf-8\" src=\"plug-in/ueditor/ueditor.all.min.js\"></script>");
		}
		if (oConvertUtils.isIn("uploadify", types)) {
			...
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/uploadify/css/uploadify.css\" type=\"text/css\"></link>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/plupload/plupload.full.min.js\"></script>");
