...
public class CgformFtlController extends BaseController {
	...
	public ModelAndView addorupdate(CgformFtlEntity cgformFtl,
    	...
    	sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/accordion/css/accordion.css\"></link>");
    	...
    	sb.append("<script type=\"text/javascript\" src=\"plug-in/ueditor/ueditor.config.js\"></script>");
    	sb.append("<script type=\"text/javascript\" src=\"plug-in/ueditor/ueditor.all.js\"></script>");
