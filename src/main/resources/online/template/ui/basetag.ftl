...
<#if style=="bootstrap">
  ...
  <!-- icheck组件引用 -->
  <link href="plug-in/hplus/css/plugins/iCheck/custom.css" rel="stylesheet">
  <script type="text/javascript" src="plug-in/hplus/js/plugins/iCheck/icheck.min.js"></script>
  <!-- Validform扩展样式 -->
...
<#else>
  ...
  <script type="text/javascript" src="plug-in/easyui/locale/${lang}.js"></script>
...
<#if validform==true>
  <script type="text/javascript" src="plug-in/Validform/js/Validform_v5.3.1_min_${lang}.js"></script>
  <script type="text/javascript" src="plug-in/Validform/js/Validform_Datatype_${lang}.js"></script>
  <script type="text/javascript" src="plug-in/Validform/js/datatype_${lang}.js"></script>
