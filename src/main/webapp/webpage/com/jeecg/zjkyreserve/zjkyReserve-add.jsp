...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zjkyReserveController.do?doAdd" tiptype="1" >
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>考生类型：</b>
			          		...
			          		<div class="col-xs-3">
							  <t:dictSelect field="userType" type="list" extendJson="{class:'form-control',style:'width:158px'}" typeGroupCode="userType"  hasLabel="false"  title="考生类型"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>报考专业：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="major" name="major" maxlength="32" type="text" class="form-control"  ignore="ignore" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
