...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zjkySchoolController.do?doAdd" tiptype="1" >
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>代码：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="code" name="code" maxlength="32" type="text" class="form-control"  ignore="ignore" />
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>名称：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="name" name="name" maxlength="50" type="text" class="form-control"  ignore="ignore" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>城市：</b>
			          		...
			          		<div class="col-xs-3">
							  <%-- <t:dictSelect field="city" type="list" extendJson="{class:'form-control',style:'width:158px'}" typeGroupCode=""  hasLabel="false"  title="城市"></t:dictSelect> --%>
							  <input type="text" id="city" name="city" class="ac_input">
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>属性：</b>
			          		...
			          		<div class="col-xs-3">
							  <%-- <t:dictSelect field="attribute" type="list" extendJson="{class:'form-control',style:'width:158px'}" typeGroupCode="schoolAttr"  hasLabel="false"  title="属性"></t:dictSelect> --%>
							  <t:dictSelect field="attribute" type="checkbox" typeGroupCode="schoolAttr" title="属性"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>类型：</b>
			          		...
			          		<div class="col-xs-3">
							  <t:dictSelect field="kind" type="list" extendJson="{class:'form-control',style:'width:158px'}" typeGroupCode="schoolKind"  hasLabel="false"  title="类型"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>隶属：</b>
			          		...
			          		<div class="col-xs-3">
							  <%-- <t:dictSelect field="subjection" type="list" extendJson="{class:'form-control',style:'width:158px'}" typeGroupCode="schoolLs"  hasLabel="false"  title="隶属"></t:dictSelect> --%>
							  <t:dictSelect field="subjection" type="radio" typeGroupCode="schoolLs" title="隶属"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					 ...
					 <div class="row show-grid">
			          ...
			          <div class="col-xs-3">
						    	...
						    	<textarea name="info" id="info" style="width: 650px;height:300px"></textarea>
					 ...
					 <div class="row show-grid">
			          ...
			          <div class="col-xs-3">
						    	<textarea name="guide" id="guide" style="width: 650px;height:300px"></textarea>
							    <script type="text/javascript">
					 ...
					 <div class="row show-grid">
			          ...
			          <div class="col-xs-3">
						    	<textarea name="tuition" id="tuition" style="width: 650px;height:300px"></textarea>
							    <script type="text/javascript">
					 ...
					 <div class="row show-grid">
			          ...
			          <div class="col-xs-3">
						    	<textarea name="score" id="score" style="width: 650px;height:300px"></textarea>
							    <script type="text/javascript">
					 ...
					 <div class="row show-grid">
			          ...
			          <div class="col-xs-3">
						    	<textarea name="retest" id="retest" style="width: 650px;height:300px"></textarea>
							    <script type="text/javascript">
