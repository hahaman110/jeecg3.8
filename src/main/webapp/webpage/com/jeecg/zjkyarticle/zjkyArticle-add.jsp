...
<style type="text/css">
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zjkyArticleController.do?doAdd" tiptype="1">
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>标题：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="title" name="title" maxlength="32" type="text" class="form-control"  datatype="*" />
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>作者OR来源：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="author" name="author" maxlength="32" type="text" class="form-control"  datatype="*" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>标签：</b>
			          		...
			          		<div class="col-xs-3">
								...
								<input id="tags" name="tags" maxlength="32" type="text" class="form-control"  datatype="*" />
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>简介：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="info" name="info" type="text" class="form-control"  datatype="*" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>阅读数：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="readnum" name="readnum" maxlength="32" type="text" class="form-control"  datatype="*" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>权重：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="weight" name="weight" maxlength="32" type="text" class="form-control"  datatype="*" value="0" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>状态：</b>
			          		...
			          		<div class="col-xs-3">
							  <t:dictSelect field="status" type="list" extendJson="{class:'form-control',style:'width:158px'}" typeGroupCode="status"  hasLabel="false"  title="状态"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>分类：</b>
			          		...
			          		<div class="col-xs-3">
					<t:treeSelectTag id="categoryid" field="categoryid" code = "A04" inputClass="form-control extWidth" formStyle="ace" 
...
<script type="text/javascript">
   $(function(){
   	$("#readnum").val(Math.floor(Math.random()*400+100));
   	$("select[name='status']:first").find("option:eq(1)").attr("selected", true);
