...
<body>
	...
	<div class="schools_detail">
		<div class="container clearfix">
			<jsp:include page="/web/to/detail_header_side?attr=2"></jsp:include>
			<div class="schools_left clearfix">
				<div class="introduce schools_guide">
					<h3>${schoolEntity.name }招生简章</h3>
					<div class="txt">
						${schoolEntity.guide }
					</div>
	...
	<script type="text/javascript">
		$(function(){
			var txtHeight=$(".schools_guide .txt").height();
			var nextHeight=txtHeight-txtHeight/3;
			$(".schools_guide .txt").css('height', nextHeight);
			$(".view_all").click(function(){
				$(".schools_guide .txt").animate({height:txtHeight},500);
				$(this).hide();
				$(".hide_all").css("display","block");
			})
			$(".hide_all").click(function(){
				$(".schools_guide .txt").animate({height:nextHeight},500);
				$(this).hide();
				$(".view_all").show();
			})
		});	
