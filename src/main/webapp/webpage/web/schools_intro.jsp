...
<body>
	...
	<div class="schools_detail">
		<div class="container clearfix">
			<jsp:include page="/web/to/detail_header_side?attr=1"></jsp:include>
	...
	<script type="text/javascript">
		$(function(){
			var txtHeight=$(".schools_intro .txt").height();
			var nextHeight=txtHeight-txtHeight/2;
			$(".schools_intro .txt").css('height', nextHeight);
			$(".view_all").click(function(){
				$(".schools_intro .txt").animate({height:txtHeight},500);
				$(this).hide();
				$(".hide_all").css("display","block");
			})
			$(".hide_all").click(function(){
				$(".schools_intro .txt").animate({height:nextHeight},500);
				$(this).hide();
				$(".view_all").show();
			})
		});	
