var Pagination = {
    ...
    Finish: function() {
    	...
    	Pagination.code = '<a class="firstpage" href="'+Pagination.url+'&page='+1+'">首页</a><a class="previous"'+pre+' title="上一页"><</a>'
    						+Pagination.code
    						+'<a class="nextpage"'+next+'title="下一页"><span class="Bg"><b>></b></span></a><a class="lastpage" href="'+Pagination.url+'&page='+(Pagination.pageTotal)+'">尾页</a>';
