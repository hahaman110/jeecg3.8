var Pagination = {
    ...
    Finish: function() {
    	...
    	Pagination.code = '<a href="'+Pagination.url+'&page='+1+'"><span class="Bg"><b>首页</b></span></a><a class="previous"'+pre+' title="上一页"><span class="Bg"><b>上一页</b></span></a>'
    						+Pagination.code
    						+'<a class="nextpage"'+next+'title="下一页"><span class="Bg"><b>下一页</b></span></a><a href="'+Pagination.url+'&page='+(Pagination.pageTotal)+'"><span class="Bg"><b>末页</b></span></a>';
